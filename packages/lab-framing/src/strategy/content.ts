...
export const ARCHETYPES: Archetype[] = [
  { name: "Knowledge Assistant", bestFit: "Internal search, policy lookup, support docs, employee enablement", dataNeeded: "Curated documents, policies, FAQs — with clear ownership and freshness", risks: "Stale sources, weak citations, hallucinated policy answers", controls: "Citation enforcement, source freshness, confidence threshold", metric: "Handle time ↓, first-contact resolution ↑, answer consistency" },
  { name: "Workflow Summarization", bestFit: "Call notes, case & claim summaries, meeting recaps, research synthesis", dataNeeded: "Transcripts, notes, source records — often with PII to redact", risks: "Omitted details, incorrect emphasis, privacy leakage", controls: "Human review, redaction, summary quality checks", metric: "Time saved per summary, reviewer edit rate" },
  { name: "Decision Support", bestFit: "Recommendations, prioritization, risk review, financial analysis", dataNeeded: "Structured records + supporting evidence for each recommendation", risks: "Unsupported recommendations, bias, unclear rationale", controls: "Explainability, evidence links, human approval", metric: "Decision quality, cycle time, approval rate" },
  { name: "Agentic Workflow", bestFit: "Multi-step task execution, tool use, approvals, escalations", dataNeeded: "APIs/tools with scoped permissions and a system of record", risks: "Runaway actions, tool misuse, excessive cost", controls: "Permission boundaries, step logging, action approval", metric: "Tasks completed autonomously, cost per task, error rate" },
...
export const VALUE_CARDS = [
  ...
  { title: "Score value and readiness", body: "A live 0–100 readiness score across value, data, feasibility, risk and adoption — with the gates you must clear." },
