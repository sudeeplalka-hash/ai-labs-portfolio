...
export const SCENARIOS: Scenario[] = [
  {
    ...
    workstreams: [
      ...
      },
      {
        ...
        summary: "Known red: extraction accuracy below bar on nonstandard documents; escalated.",
        brief: {
          whatChanged: "No movement. Accuracy on nonstandard docs stuck at 68% vs 90% target.",
        ...
        raid: {
          ...
          issues: [{ text: "68% extraction accuracy on nonstandard docs", sev: "high" }],
