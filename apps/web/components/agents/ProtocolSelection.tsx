    ...
    <div className="min-h-screen bg-canvas font-sans text-ink">
      ...
      <main className="mx-auto max-w-6xl px-4 py-6 md:px-5 md:py-8">
        ...
        <div className="mt-8 space-y-4 border-t border-line pt-6">
          <OutcomeFrame call="Select the protocol based on the integration pattern, not the trend cycle." lift="Improves architecture consistency and avoids premature standardization or unnecessary custom integration." measure="Integration reuse, onboarding time, tool adoption, change effort, support complexity." />
          ...
          <p className="text-sm leading-relaxed text-ink"><span className="font-semibold">Steering committee takeaway:</span> {activeUc ? activeUc.takeaway : "The protocol is not the first question. Count the systems, consumers, coordination needs, and governance constraints. The protocol follows from that shape."}</p>
          ...
          <p className="text-xs text-slatey-500"><span className="font-semibold text-slatey-400">Limitations:</span> this artifact is a decision model, not a full architecture review. Production selection would require security review, platform standards, vendor constraints, latency requirements, and implementation testing.</p>
        </div>
