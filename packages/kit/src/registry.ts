...
export const LABS: LabEntry[] = [
  ...
  {
    id: "GAP-02", collection: 2, title: "Agent Loop & Failure Inspector", status: "in-build", live: "SIMULATED", priority: "P1",
  ...
  {
    id: "GAP-06", collection: 2, title: "Prompt Cost & Token Simulator", status: "in-build", live: "SIMULATED", priority: "P1",
  ...
  {
    id: "GAP-07", collection: 2, title: "Protocol Selection Lab", status: "in-build", live: "SIMULATED", priority: "P0", flagship: true,
  ...
  {
    id: "C3-3", collection: 3, title: "Inference Cost Forecaster", status: "in-build", live: "SIMULATED",
  ...
  {
    id: "EL-02", collection: 4, title: "Stakeholder & Sponsor Alignment Cockpit", status: "in-build", live: "SIMULATED", priority: "P1",
  ...
  {
    id: "EL-06", collection: 4, title: "Talent & Upskilling Pathway Planner", status: "in-build", live: "SIMULATED", priority: "P2",
  ...
  {
    id: "EL-09", collection: 4, title: "Resource Onboarding & KT Tracker", status: "in-build", live: "SIMULATED", priority: "P2",
  ...
  {
    id: "EL-10", collection: 4, title: "Executive Communication Studio", status: "in-build", live: "SIMULATED", liveNote: "per-section talk track may run LIVE", priority: "P1",
