...
export interface StoryStep {
  ...
  detail: string;     // 1 to 2 sentences of judgment
}
...
export const STORYLINES: Storyline[] = [
  {
    ...
    steps: [
      ...
      { labId: "C1-operate", stage: "…then run it", headline: "Week 7: the SLOs stay green while the answers decay", detail: "Day Two is where programs are won: a stale index, a silent canary slide, and the retrain / reindex / rollback / rescope call that loops back to the next Frame. Shipping was the middle of the story, not the end." },
    ],
  },
  {
