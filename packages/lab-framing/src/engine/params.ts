...
export const PAINS: Record<PainKey, { sev: number; phr: string }> = {
  "Too slow": { sev: 0.6, phr: "waiting" },
  "Inconsistent": { sev: 0.65, phr: "getting different answers each time" },
  "Too expensive": { sev: 0.7, phr: "burning budget" },
  "Hard to scale": { sev: 0.7, phr: "hitting a ceiling" },
  "Error prone": { sev: 0.85, phr: "making costly mistakes" },
  "Knowledge trapped": { sev: 0.75, phr: "hunting for what's already known" },
  "Poor experience": { sev: 0.6, phr: "frustrated" },
  "Impossible today": { sev: 0.9, phr: "unable to do this at all" },
};
