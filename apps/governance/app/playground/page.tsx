...
import type { UseCase, PlaygroundResponse } from '@/lib/types';
import { DecisionBadge, SeverityBadge } from '@/components/shared/Badge';
import { LoadingSpinner } from '@/components/shared/LoadingSpinner';
import { cn } from '@/lib/utils';
import { useLens } from '@/lib/lens';
import { PipelineFlow } from '@/components/playground/PipelineFlow';
import { GUARDRAIL_LINKS } from '@/lib/evidence-links';
  ...
  return (
    <div className="p-8 space-y-6">
      <div>
        ...
        <p className="text-sm text-slate-500 mt-1">Submit prompts and observe real-time guardrail decisions, trace, and audit events</p>
      </div>
