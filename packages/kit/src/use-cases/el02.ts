    ...
    payload: {
      ...
      stakeholders: [
        ...
        { key: "legis", name: "Legislative liaison", role: "Keep satisfied", power: 0.7, interest: 0.5, traj: [2, 2, 2, 2, 2, 2],
          brief: { why: "Neutral, cost and optics focused; wants the taxpayer value story.", who: "You, with the cost per case figure.", message: "Share cost per case and the equity of access safeguards; preempt the optics question.", before: "With the oversight pre read." } },
    ...
    payload: {
      ...
      stakeholders: [
        ...
        { key: "fin", name: "R&D finance partner", role: "Keep informed", power: 0.55, interest: 0.6, traj: [2, 2, 2, 2, 2, 2],
          brief: { why: "Neutral; wants the cost per program story.", who: "You, with the economics.", message: "Share the cycle time to cost translation; preempt the spend question.", before: "With the pre read." } },
      ],
    },
  },
  {
