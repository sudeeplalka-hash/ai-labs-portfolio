...
export const EL08_USE_CASES: UseCase<El08Payload>[] = assertUseCases<El08Payload>([
  {
    ...
    theDecision:
      "Price the document long tail as a line item: data readiness on nonstandard claim forms and the eval harness are where insurance AI estimates blow up, so surface them as their own WBS rows and present the PERT range, not the point.",
    whatMostMiss:
