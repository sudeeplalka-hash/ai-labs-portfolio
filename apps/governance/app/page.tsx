...
import { RiskBadge, DecisionBadge } from '@/components/shared/Badge';
import { LoadingSpinner } from '@/components/shared/LoadingSpinner';
import { riskScoreColor, formatDateTime } from '@/lib/utils';
import {
  ...
  return (
    <div className="p-8 space-y-8">
      ...
      <div>
        ...
        <p className="text-sm text-slate-500 mt-1">Real-time view of AI risk, policy coverage, and governance controls</p>
      </div>
      ...
      <div className="rounded-xl border border-slate-200 bg-white p-5 shadow-card flex items-center justify-between gap-4 flex-wrap">
        ...
        <div className="flex items-center gap-2 shrink-0">
          <Link href="/live" className="inline-flex items-center gap-1.5 bg-primary text-white text-sm font-medium px-4 py-2 rounded-lg hover:opacity-90">
