...
export const LABS: LabEntry[] = [
  ...
  {
    id: "GAP-01", collection: 2, title: "MCP Server Contract Workbench", status: "in-build", live: "SIMULATED", priority: "P0", flagship: true,
  ...
  {
    id: "GAP-02", collection: 2, title: "Agent Failure and Recovery Inspector", status: "in-build", live: "SIMULATED", priority: "P1",
  ...
  {
    id: "GAP-03", collection: 2, title: "Multiagent Orchestration Economics Board", status: "in-build", live: "SIMULATED", liveNote: "LIVE ready, flips to LIVE when the host model endpoint is configured", priority: "P0", flagship: true,
  ...
  {
    id: "GAP-04", collection: 2, title: "Structured Output Reliability Gate", status: "in-build", live: "SIMULATED", liveNote: "LIVE ready, flips to LIVE when the host model endpoint is configured", priority: "P1",
  ...
  {
    id: "GAP-05", collection: 2, title: "Context and Memory Strategy Evaluator", status: "in-build", live: "SIMULATED", priority: "P2",
  ...
  {
    id: "GAP-06", collection: 2, title: "Token Economics Simulator", status: "in-build", live: "SIMULATED", priority: "P1",
  ...
  {
    id: "GAP-07", collection: 2, title: "Protocol Selection Decision Model", status: "in-build", live: "SIMULATED", priority: "P0", flagship: true,
  ...
  {
    id: "GAP-08", collection: 2, title: "Human Review and Autonomy Control Simulator", status: "in-build", live: "SIMULATED", priority: "P1",
  ...
  {
    id: "C3-1", collection: 3, title: "AI Portfolio Capital Allocation Dashboard", status: "in-build", live: "SIMULATED", flagship: true,
  ...
  {
    id: "C3-2", collection: 3, title: "Build, Buy, or Fine Tune Decision Evaluator", status: "in-build", live: "SIMULATED",
  ...
  {
    id: "C3-3", collection: 3, title: "Inference Run Rate Forecaster", status: "in-build", live: "SIMULATED",
  ...
  {
    id: "C3-4", collection: 3, title: "Vendor Selection and Concentration Risk Monitor", status: "in-build", live: "SIMULATED",
  ...
  {
    id: "C3-5", collection: 3, title: "AI Business Case and ROI Builder", status: "in-build", live: "SIMULATED",
  ...
  {
    id: "EL-01", collection: 4, title: "Adoption Readiness Decision Instrument", status: "in-build", live: "SIMULATED", priority: "P0", flagship: true,
  ...
  {
    id: "EL-02", collection: 4, title: "Stakeholder and Sponsor Alignment Cockpit", status: "in-build", live: "SIMULATED", priority: "P1",
  ...
  {
    id: "EL-03", collection: 4, title: "Capacity and Skills Coverage Planner", status: "in-build", live: "SIMULATED", priority: "P0",
  ...
  {
    id: "EL-04", collection: 4, title: "Delivery Health and RAID Radar", status: "in-build", live: "SIMULATED", liveNote: "status narrative may run LIVE", priority: "P1",
  ...
  {
    id: "EL-06", collection: 4, title: "Talent and Upskilling Pathway Planner", status: "in-build", live: "SIMULATED", priority: "P2",
  ...
  {
    id: "EL-07", collection: 4, title: "RFP and Bid Decision War Room", status: "in-build", live: "SIMULATED", liveNote: "requirement extraction may run LIVE", priority: "P1",
  ...
  {
    id: "EL-08", collection: 4, title: "Estimation and Scope Control Studio", status: "in-build", live: "SIMULATED", priority: "P1",
  ...
  {
    id: "EL-09", collection: 4, title: "Onboarding and Knowledge Transfer Tracker", status: "in-build", live: "SIMULATED", priority: "P2",
  ...
  {
    id: "EL-10", collection: 4, title: "Executive Communication Decision Studio", status: "in-build", live: "SIMULATED", liveNote: "per section talk track may run LIVE", priority: "P1",
