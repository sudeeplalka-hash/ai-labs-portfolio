...
export const GAP08_USE_CASES: UseCase<Gap08Payload>[] = assertUseCases<Gap08Payload>([
  {
    ...
    sources: [
      "Credit-decisioning autonomy / fair-lending (ECOA) controls, firsthand (cards & lending)",
    ...
    payload: {
      ...
      tiers: [
        { tier: "High risk (credit · fair lending)", tone: "rose", max: "L1 to L2" },
        { tier: "Borderline / thin-file", tone: "amber", max: "L3" },
        { tier: "Clear approve / deny", tone: "emerald", max: "L4 to L5" },
      ],
      defaultLevel: 2,
    },
  },
  {
    ...
    payload: {
      ...
      tiers: [
        { tier: "High-harm (threats, CSAM)", tone: "rose", max: "L1 to L2" },
        { tier: "Borderline / context-dependent", tone: "amber", max: "L3" },
        { tier: "Clearly benign", tone: "emerald", max: "L4 to L5" },
      ],
      defaultLevel: 2,
    },
  },
  {
    ...
    payload: {
      ...
      tiers: [
        { tier: "High-acuity (never auto-file)", tone: "rose", max: "L1 to L2" },
        { tier: "Moderate acuity", tone: "amber", max: "L3" },
        { tier: "Low-acuity / routine", tone: "emerald", max: "L4 to L5" },
      ],
      defaultLevel: 2,
    },
  },
